...
const RCTLegacyUserNotificationManager =
  NativeModules.LegacyUserNotificationManager;
...
const PushNotificationEmitter = new NativeEventEmitter(
  RCTLegacyUserNotificationManager
);
...
const DEVICE_NOTIF_EVENT = "notificationReceived";
 ...
 *
 *   `#import <React/RCTLegacyPushNotificationManager.h>`
 ...
 *    {
 *     [RCTLegacyPushNotificationManager didRegisterUserNotificationSettings:notificationSettings];
 *    }
 ...
 *    {
 *     [RCTLegacyPushNotificationManager didReceiveLocalNotification:notification];
 *    }
 *   ```
 */
class IOSLegacyUserNotificationHandler implements NotificationHandler {
  static FetchResult = {
  ...
  presentLocalNotification = (details: Object) => {
    RCTLegacyUserNotificationManager.presentLocalNotification(details);
  };
  ...
  scheduleLocalNotification = (details: Object) => {
    RCTLegacyUserNotificationManager.scheduleLocalNotification(details);
  };
  ...
  cancelAllLocalNotifications = () => {
    RCTLegacyUserNotificationManager.cancelAllLocalNotifications();
  };
  ...
  cancelLocalNotifications = (userInfo: Object) => {
    RCTLegacyUserNotificationManager.cancelLocalNotifications(userInfo);
  };
  ...
  getScheduledLocalNotifications = (callback: Function) => {
    RCTLegacyUserNotificationManager.getScheduledLocalNotifications(callback);
  };
  ...
  addEventListener = (type: PushNotificationEventName, handler: Function) => {
    invariant(
      ...
      "PushNotificationIOS only supports `notification`, `register`, `registrationError`, and `contentAvailableNotification` events"
    );
    let listener;
  ...
  requestPermissions = (permissions?: {
    ...
    return RCTLegacyUserNotificationManager.requestPermissions(
      requestedPermissions
    ).then(() =>
  ...
  checkPermissions = (callback: Function) => {
    ...
    RCTLegacyUserNotificationManager.checkPermissions(callback);
  };
  ...
  getInitialNotification = (): Promise<?IOSUserNotification> => {
    return RCTLegacyUserNotificationManager.getInitialNotification().then(
      notification => notification && new IOSUserNotification(notification)
    );
  };
}

module.exports = IOSLegacyUserNotificationHandler;
